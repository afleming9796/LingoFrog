...
function setImportType(type) {
  ...
  if (type === 'phrases') {
    importHint.innerHTML = 'One phrase per line. Casing is preserved on insertion.<br>e.g. <code>Thanks for the quick turnaround</code><br><br>Tip: highlight text in any field and press <code>⌘ + Shift + P</code> to save it directly.';
